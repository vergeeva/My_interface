...
namespace Myinterface {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ ñîõğàíèòüÈÂûéòèToolStripMenuItem1;
	private: System::Windows::Forms::ToolStripMenuItem^ âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ñîõğàíèòüÈÂûéòèToolStripMenuItem1 = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1 = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->toolStripMenuItem1->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
				this->ñîõğàíèòüÈÂûéòèToolStripMenuItem1,
					this->âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1
			});
			this->toolStripMenuItem1->Name = L"toolStripMenuItem1";
			this->toolStripMenuItem1->Size = System::Drawing::Size(67, 24);
			this->toolStripMenuItem1->Text = L"Âûõîä";
			// 
			// ñîõğàíèòüÈÂûéòèToolStripMenuItem1
			// 
			this->ñîõğàíèòüÈÂûéòèToolStripMenuItem1->Name = L"ñîõğàíèòüÈÂûéòèToolStripMenuItem1";
			this->ñîõğàíèòüÈÂûéòèToolStripMenuItem1->Size = System::Drawing::Size(251, 26);
			this->ñîõğàíèòüÈÂûéòèToolStripMenuItem1->Text = L"Ñîõğàíèòü è âûéòè";
			this->ñîõğàíèòüÈÂûéòèToolStripMenuItem1->Click += gcnew System::EventHandler(this, &MainForm::ñîõğàíèòüÈÂûéòèToolStripMenuItem1_Click);
			// 
			// âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1
			// 
			this->âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1->Name = L"âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1";
			this->âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1->Size = System::Drawing::Size(251, 26);
			this->âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1->Text = L"Âûéòè áåç ñîõğàíåíèÿ";
			this->âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1->Click += gcnew System::EventHandler(this, &MainForm::âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1_Click);
			// 
			...
			this->contextMenuStrip1->Size = System::Drawing::Size(219, 124);
			// 
	...
	private: System::Void îòêğûòüToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			System::Windows::Forms::DialogResult::OK)
		{
			...
			if (richTextBox1->Text == "")
			{
				...
				âûäåëèòüÂñåToolStripMenuItem->Enabled = false;
				âûğåçàòüToolStripMenuItem->Enabled = false;
				êîïèğîâàòüToolStripMenuItem->Enabled = false;
			}
			else
			{
				...
				âûäåëèòüÂñåToolStripMenuItem->Enabled = true;
				âûğåçàòüToolStripMenuItem->Enabled = true;
				êîïèğîâàòüToolStripMenuItem->Enabled = true;
...
private: System::Void äîáàâèòüÂÑëîâàğüToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	Form^ Frm = gcnew Child_1(richTextBox1->SelectedText);
	Frm->ShowDialog();
}

private: System::Void ñîõğàíèòüÈÂûéòèToolStripMenuItem1_Click(System::Object^ sender, System::EventArgs^ e) {
	ñîõğàíèòüToolStripMenuItem_Click(sender, e);
	this->Close();
}
private: System::Void âûéòèÁåçÑîõğàíåíèÿToolStripMenuItem1_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Close();
}
};
};
